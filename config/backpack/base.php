...
// Relative path to mix-manifest.json, from root folder public/
...
return [
    ...
    */
    ...
    'project_name' => 'PeerAssess Admin Panel',
    ...
    'mix_styles' => [ // file_path => manifest_directory_path
        'css/app.css' => $manifest_directory_path,
    ],
    ...
    'developer_name' => 'Damianos Giankakis',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'http://dgiankakis.gr',
    ...
    'scripts' => [
        ...
        // exampBACKPACK_REGISTRATION_OPENles (everything inside the bundle, loaded from CDN)
    ...
    'mix_scripts' => [// file_path => manifest_directory_path
        'js/app.js' => $manifest_directory_path,
    ],
