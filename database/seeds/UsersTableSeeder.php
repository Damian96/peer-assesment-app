...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users = array(
            ...
            array('id' => \App\Course::DUMMY_ID, 'email' => 'dummy@citycollege.sheffield.eu', 'email_verified_at' => '2020-02-08 00:00:00', 'fname' => 'Joe', 'lname' => 'Doe', 'department' => 'CS', 'reg_num' => 'CS17021', 'instructor' => '0', 'admin' => '0', 'password' => '$2y$10$IfDFpctQS6PtZP2YucTVsuSUwNY3Pi1vbc7/nSiIFWJJtHY/PrXby')
        );
