...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users = array(
            ...
            array('email' => 'kdimitropoulos@citycollege.sheffield.eu', 'email_verified_at' => NULL, 'fname' => 'Konstantinos', 'lname' => 'Dimitropoulos', 'department' => 'CS', 'reg_num' => 'CS17021', 'instructor' => '0', 'admin' => '0', 'password' => '$2y$10$IfDFpctQS6PtZP2YucTVsuSUwNY3Pi1vbc7/nSiIFWJJtHY/PrXby')
        );
