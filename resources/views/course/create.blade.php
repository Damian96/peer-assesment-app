        ...
        <div class="col-md-8 offset-md-2">
            <form role="form" method="POST" action="{{ url('/course/create') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" id="title" type="text" required aria-required="true" maxlength="50" aria-valuemax="50" placeholder="e.g. level 3 course of java programming" aria-placeholder="e.g. level 3 course of java programming" aria-invalid="{{ $errors->has('title') ? 'true' : 'false' }}" pattern="[a-zA-Z0-9\-_]">
